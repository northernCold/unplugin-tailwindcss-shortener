    ...
    >
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="cx($route.name === 'Dashboard' ? activeClass : inactiveClass)"
          to="/dashboard"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'UIElements' ? activeClass : inactiveClass)"
          to="/ui-elements"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'Tables' ? activeClass : inactiveClass)"
          to="/tables"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'Forms' ? activeClass : inactiveClass)"
          to="/forms"
        >
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'Cards' ? activeClass : inactiveClass)"
          to="/cards"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'Modal' ? activeClass : inactiveClass)"
          to="/modal"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="cx($route.name === 'Blank' ? activeClass : inactiveClass)"
          to="/blank"
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path
