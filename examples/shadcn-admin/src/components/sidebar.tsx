      ...
      <Layout>
        ...
        <LayoutHeader className='sticky top-0 justify-between px-4 py-3 shadow md:px-4'>
          <div className={cn('flex items-center', !isCollapsed ? 'gap-2' : '')}>
            ...
            <div
              className={cn('flex flex-col justify-end truncate', isCollapsed ? 'invisible w-0' : 'visible w-auto')}
            >
        ...
        <Nav
          id='sidebar-menu'
          className={cn('h-full flex-1 overflow-auto', navOpened ? 'max-h-screen' : 'max-h-0 py-0 md:max-h-screen md:py-2')}
